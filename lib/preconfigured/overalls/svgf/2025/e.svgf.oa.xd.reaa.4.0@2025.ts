...
export default partiallyConfigureOverallModel(svgfRhOverall2025, {
  ...
  competitionEventOptions: {
    ...
    'e.svgf.fs.sr.srpf-rh.2.75@2025': { name: 'Single Rope Pair Freestyle' },
    ...
    'e.svgf.fs.dd.ddsf-rh.3.75@2025': { name: 'Double Dutch Single Freestyle' },
    'e.svgf.fs.dd.ddpf-rh.4.75@2025': { name: 'Double Dutch Pair Freestyle' },
  },
  id: 'e.svgf.oa.xd.reaa.4.0@2025',

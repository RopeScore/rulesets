...
export default partiallyConfigureOverallModel(ijruOverall100, {
  ...
  competitionEventOptions: {
    ...
    'e.ijru.fs.sr.srif.1.75@4.0.0': { name: 'Single Rope Individual Freestyle', rankMultiplier: 2, normalisationMultiplier: 2 },
  },
  id: 'e.ijru.oa.sr.isro.1.0@4.0.0',
  name: 'Individual Overall',
})
